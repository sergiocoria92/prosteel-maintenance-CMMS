...
export default async function RevenueChart() {
  // Reusamos revenue (ya existe)
  // Interpretaremos "revenue" como porcentaje (0..100)
  const revenue = await fetchRevenue();

  const chartHeight = 350;

  // Y-axis fijo en 100% para que sea estable visualmente
  const topLabel = 100;
          ...
          {revenue.map((month) => (
            <div key={month.month} className="flex flex-col items-center gap-2">
              <div
                ...
                style={{
                  // Convertimos el valor a altura usando topLabel=100
